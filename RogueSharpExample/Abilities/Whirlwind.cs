    ...
    public class Whirlwind : Ability
    {
        ...
        protected override bool PerformAbility()
        {
            ...
            else
            {
                ...
                Game.MessageLog.Add($"{player.Name} performs a whirlwind attack against all enemies {_range} tile(s) away");
                ...
                foreach (Point monsterLocation in monsterLocations)
                {
                    ...
                    if (monster != null)
                    {
                        ...
                        if (Dice.Roll("1D100") < _poisonChance)
                        {
                            ...
                            {
                                monster.State = new MonsterAbnormalState(monster, 3, "Poisoned", -1, -1, _poisonLength, _poisonDamage);
                            }
                        }
                    }
                }
